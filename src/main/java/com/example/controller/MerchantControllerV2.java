...
//@CrossOrigin(origins = "http://184.72.75.108:8080", allowedHeaders= {"Content-Type, Accept, X-Requested-With"},methods)
@RestController
...
public class MerchantControllerV2 {
	...
	@ApiOperation(value="deletes merchant whose id provided in URL")
